...
public class FirebaseNewsViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public void bindNews(Article article) {
        mNewsImageView = (ImageView) mView.findViewById(R.id.newsImageView);
    ...
    public void onClick(View view) {
        ...
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference(Constants.FIREBASE_CHILD_NEWS).child(uid);
